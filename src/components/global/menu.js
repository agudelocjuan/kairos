  ...
  return (
    <Container fluid id="menu" className={`${menu ? "show" : ""}`}>
      ...
      <Row className="cta-row">
        ...
        >
          <a href="https://www.facebook.com" className="pl-3">
            <img src={facebook} alt="" />
          </a>
          <a href="https://www.instagram.com" className="pl-3">
            <img src={instagram} alt="" />
          </a>
          <a href="https://www.twitter.com" className="pl-3">
            <img src={twitter} alt="" />
          </a>
          <a href="https://www.linkedin.com" className="pl-3">
