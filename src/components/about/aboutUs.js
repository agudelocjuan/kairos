  ...
  const team = [
    {
      ...
      bio2:
        "Previously, he was named a Leader del Futuro by the Ambrosetti Forum and as a Young Leader by both the World Foresight Forum and the St. Petersburg International Economic Forum. In 2011, Inc. magazine named Ankur Jain the “Best Connected 21-Year-Old in the World” and awarded Jain “30 Under 30.”",
      bio3:
        "In 2012, Jain was named “30 under 30: Solution Broker” by the Christian Science Monitor.",
      bio4:
    ...
    },
    {
      ...
      img: "joyce_ok",
      bio:
        "Joyce Ok is an Associate at Kairos, focused on financial strategy. She sits on the capital team, providing financial & operational support to the Kairos family of companies. Previously, Joyce worked in investment banking at Goldman Sachs in the Real Estate, Gaming, and Lodging group on multiple acquisitions and capital raises including multi-billion dollar transactions, debt raises, and IPOs. She then went on to work in business operations at Birdy Grey, a DTC retail start-up based in New York City. Joyce graduated from Brown University where she studied Business Economics.",
    },
    {
      ...
      bio:
        "Mary Martha (just call her MM) joins Kairos from Glossier, a D2C unicorn in the beauty and personal care space, where she built the research and insights function from the ground up. As Head of Consumer Insights at Glossier, MM built an infrastructure for research, and a culture of using this research to make strategic decisions ranging from concept development, to new market evaluation, to brand strategy.",
      bio2:
      ...
      bio3:
        "MM started her career at political polling firm PSB after getting her MA in Political Science while working the early shift for CNBC’s early, early show Worldwide Exchange. MM is a native New Yorker and received both her BA in 2011 and MA in 2012 from Columbia University. ",
    },
    {
      name: "Carly Reilly",
      ...
      img: "carly_reilly",
      bio:
        "Carly Reilly is the Head of Communications at Kairos HQ. She previously served as the deputy chief of staff and then national finance director for Andrew Yang's 2020 presidential campaign. Raising nearly $40 million dollars in an average of $35 increments, Carly helped to spur Yang’s nationwide momentum, propelling him to seven Democratic primary debates. According to CNN, their campaign 'didn't just make history... [it] unquestionably put a sizable dent in the future as well.'",
      bio2:
        "Carly is a Washington Post contributor and has been featured in the New York Times, Washington Post Magazine, BuzzFeed, and Bloomberg. She lives in New York City and graduated from Tufts University where she studied political science and computer science.",
    },
    {
      name: "Cyrus Ferguson",
    ...
    },
    {
      ...
      img: "vicente_fox",
      bio:
        "Vicente Fox served as a the 62nd President of Mexico from December 1, 2000 to November 30th, 2006. Fox previously served as the President and Chief Execute of Coca-Cola Mexico, where he oversaw the growth of Coca-Cola’s sales by almost 50% in Mexico. He was born in Mexico City.",
    },
    {
                    ...
                    <div className="bio-box">
                      ...
                      <main>
                        ...
                        <article>
                          ...
                          {i.bio2 && <p className="bio">{i.bio2}</p>}
                          {i.bio3 && <p className="bio">{i.bio3}</p>}
                          {i.bio4 && <p className="bio">{i.bio4}</p>}
                          {i.bio5 && <p className="bio">{i.bio5}</p>}
                        </article>
                      </main>
                    </div>
                  </Modal>
