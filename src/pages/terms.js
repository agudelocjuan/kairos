...
const TermsPage = ({ location }) => {
  ...
  return (
    ...
    >
      ...
      <Container fluid id="termsPage" className="page-template">
        <Row className="d-flex justify-content-center">
          <Col md="10">
            <h1>Terms and Conditions</h1>
            <p className="bold">Last updated: July 08, 2020</p>
            <p className="bold">
            ...
            <ul>
              <li>
                <span className="bold">Affiliate </span>means an entity that
              ...
              <li>
                <span className="bold">Company </span>(referred to as either
                "the Company", "We", "Us" or "Our" in this Agreement) refers to
                Kairos Managers LLC, 31 Bond Street, New York NY 10012.
              </li>
              <li>
                <span className="bold">Content </span>refers to content such as
              ...
              <li>
                <span className="bold">Country </span>refers to: New York,
                United States
              </li>
              <li>
              ...
              <li>
                <span className="bold">Feedback </span>means feedback,
                innovations or suggestions sent by You regarding the attributes,
                performance or features of our Service.
              </li>
              <li>
                <span className="bold">Promotions </span>refer to contests,
              ...
              <li>
                <span className="bold">Terms and Conditions </span>(also
              ...
              <li>
                <span className="bold">Third-party Social Media Service </span>
              ...
              <li>
                <span className="bold">Website </span>refers to Kairos HQ,
                accessible from www.kairoshq.com
              </li>
              <li>
                <span className="bold">You </span>means the individual accessing
            ...
            <h2>Content</h2>
            <p className="bold">Your Right to Post Content</p>
            <p>
            ...
            <p className="bold">Content Restrictions</p>
            <p>
            ...
            <p className="bold">Content Backups</p>
            <p>
            ...
            <p className="bold">Intellectual Property Infringement</p>
            <p>
            ...
            <p>
              ...
              attention of our copyright agent via email at team@kairoshq.com
            ...
            <p>
              ...
              team@kairoshq.com. Upon receipt of a notification, the Company
            ...
            <ul>
              <li>By email: team@kairoshq.com</li>
              <li>
                By visiting this page on our website: www.kairoshq.com/contact
              </li>
            </ul>
          </Col>
        </Row>
